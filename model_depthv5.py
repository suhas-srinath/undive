...
class Coeffs(nn.Module):
    ...
    def __init__(self, nin=4, nout=3, params=None,ckpt=None):
        ...
        self.splat_addn_layer = nn.Conv2d(256, prev_ch, kernel_size=2, stride=2) 
...
class HDRPointwiseNN_depthv2(nn.Module):
    ...
    def __init__(self, params,ckpt):
        ...
        self.coeffs = Coeffs(params=params,ckpt=ckpt)
